    ...
    return (
        ...
        >
            ...
            <div className="w-[90%] mx-auto flex flex-col items-center justify-center text-center z-20">
                ...
                <a href="/signup" className="bg-secondary font-inter text-secondary-foreground px-6 py-3 rounded-lg hover:bg-secondary/80 transition-colors cursor-pointer shadow-[0px_0px_3px_2px_rgba(0,_0,_0,_0.1)] font-semibold ">
                    Get Started
                </a>
            </div>
        </div>
